...
!
!-----------------------------------------------------------------------
subroutine writemodes (amass, ityp, ntyp, nat,q,w2,z,iout)
  !-----------------------------------------------------------------------
  !
  !   write modes on output file in a readable way
  !
  ...
  do i = 1,nat3
     ...
     do na = 1,nat
        ...
        write (iout,9020) (amass(nta), z((na-1)*3+ipol,i)/znorm,ipol=1,3)
     end do
     !
  end do
  !write(iout,'(1x,74(''*''))')
  ...
  !
9010 format(5x,'freq ',i5,'    ',f15.6,'  THz    ',f15.6,' cm-1  ')
9020 format (1x, 3(f10.6,1x, f10.6,1x,f10.6,3x))
  !
